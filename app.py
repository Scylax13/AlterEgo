...
# push("Hey Abhinav!") # checking the pushover function
...
class Me:
    def __init__(self):
        ...
        self.resume = ""
        self.name = "Abhinav Pratap Singh"
...
You are given a summary of {self.name}'s background and a resume which you can use to answer questions. \
